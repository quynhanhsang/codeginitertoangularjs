...
$routes->post('application/file/muntiluploads', 'File::MuntilUploads', ['namespace' => 'App\Controllers\Application', 'filter' => 'auth']);
$routes->post('application/file/getListFile', 'File::getListFile', ['namespace' => 'App\Controllers\Application', 'filter' => 'auth']);
$routes->get('application/file/load', 'File::load', ['namespace' => 'App\Controllers\Application', 'filter' => 'auth']);

$routes->post('application/file/delete', 'File::delete', ['namespace' => 'App\Controllers\Application', 'filter' => 'auth']);
$routes->post('application/file/deleteAll', 'File::deleteAll', ['namespace' => 'App\Controllers\Application', 'filter' => 'auth']);
// cấu hình chung
