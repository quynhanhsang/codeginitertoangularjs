...
angular.module('MetronicApp').controller('app.menu.index', ['$rootScope','$scope', '$http', '$timeout', '$uibModal','$ngConfirm',
function($rootScope, $scope, $http, $timeout, $uibModal, $ngConfirm) {
    ...
    vm.loadData = function(){
        $http.post(ApiUrl+'/menus/getList', vm.filter)
            ...
            buttons: {
                ok: {
                    ...
                    action: function (scope) {
                        $http.post(ApiUrl+'/menus/delete', data.id)
                            .then(function(response){
            ...
            buttons: {
                ok: {
                    ...
                    action: function (scope) {
                        ...
                        $http.post(ApiUrl+'/menus/deleteAll', vm.arrCheckbox)
                        .then(function(response){
    ...
    function openCreateOrEditadvModal(data) {
        ...
        var modalInstance = $uibModal.open({
            templateUrl: baseUrl+'/app/menu/modal/createOreUpdate.html',
            controller: 'app.menu.modal.createOreUpdate as vm',
            backdrop: 'static',
            size: 'lg',
            resolve: {
                cauhinh: data
